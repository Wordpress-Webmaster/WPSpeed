...
class Wps_Wwis {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Wps_Wwis_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Wps_Wwis_Loader. Orchestrates the hooks of the plugin.
	 * - Wps_Wwis_i18n. Defines internationalization functionality.
	 * - Wps_Wwis_Admin. Defines all hooks for the admin area.
	 * - Wps_Wwis_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Wps_Wwis_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Wps_Wwis_Loader    Orchestrates the hooks of the plugin.
	 */
